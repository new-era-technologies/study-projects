...
var getCount1 = function (test1) {
    return Object.keys(test1).length
};

console.log(getCount1(test1));


var test2 = function () {
};

var getCount2 = function (test2) {
    return Object.keys(test2).length
};

console.log(getCount2(test2));


var test3 = [1, 2, 3, 4];

var getCount3 = function (test3) {
    return Object.keys(test3).length
};

console.log(getCount3(test3));
...
var getCount4 = function (test4) {
    return Object.keys(test4).length
};

console.log(getCount4(test4));
